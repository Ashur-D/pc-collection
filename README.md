...
- ❤️ [StartAllBack](https://www.startallback.com/) (Used for changing the windows startmenu, file explorer, tray icons, etc. It has a free 90 day trial)
- ❤️ [Nilesoft](https://github.com/moudey/Shell) / [Breeze-Shell](https://github.com/std-microblock/breeze-shell) (Used for changing the windows context menu)
